 ...
 * https://github.com/ngocbd/node-binance-api-ext
 * ============================================================
 * Copyright 2020+, ngocbd
...
let stopSockets = function (log = false) {
  ...
  let endpoints = binance.webSocket.subscriptions();
  for (let endpoint in endpoints) {
    if (log) console.log('Terminated ws endpoint: ' + endpoint);
    binance.webSocket.terminate(endpoint);
  }
};
...
describe('Construct', function () {
  ...
  it('Construct the binance object', function (done) {
    binance.options({
      APIKEY:
        '6ysSNoxYjHbJ2A9aOo9zYtVscDvGBaMhm0KUgxVx8cjnOuIXESE071BuNeAJFKWf',
      // '5enQYcMQk2J3syHCao9xgJOnnPoGtDMhSRRAzG2Gxo90TBzXPG1itcXikQc2VRDh',
      APISECRET:
        'lmZSYEcDVOUJsbKYK2n5wjBTYi0h9hGvd3yU9XVj0jdy3R9wffDMQ1eX3YEPjhnR',
...
describe('Prices', function () {
  it('Checks the price of BNBBTC', function (done) {
    binance.spot.prices('BNBBTC', (error, ticker) => {
      debug(error);
      debug(ticker);
...
describe('All Prices', function () {
  it('Checks the prices of coin pairs', function (done) {
    binance.spot.prices((error, ticker) => {
      debug(error);
      debug(ticker);
      assert(typeof error === 'object', WARN_SHOULD_BE_OBJ);
      assert(typeof ticker === 'object', WARN_SHOULD_BE_OBJ);
...
describe('Book Ticker', function () {
  ...
  it('Get all book tickers', function (done) {
    binance.spot.bookTickers(false, (error, ticker) => {
      assert(ticker);
      /*
      assert( error === null, WARN_SHOULD_BE_NULL );
      assert( ticker !== null, WARN_SHOULD_BE_NOT_NULL );
...
describe('Buy', function () {
  it('Attempt to buy ETH', function (done) {
    ...
    let price = 0.069;
    assert(
      typeof binance.spot.buy('ETHBTC', quantity, price) === 'undefined',
...
describe('Sell', function () {
  it('Attempt to sell ETH', function (done) {
    ...
    let price = 0.069;
    assert(
      typeof binance.spot.sell('ETHBTC', quantity, price) === 'undefined',
      WARN_SHOULD_BE_UNDEFINED
    );
    done();
  }).timeout(TIMEOUT);
...
describe('MarketBuy', function () {
  it('Attempt to buy ETH at market price', function (done) {
    let quantity = 0.001;
    assert(
      typeof binance.spot.marketBuy('BNBBTC', quantity) === 'undefined',
      WARN_SHOULD_BE_UNDEFINED
    );
    done();
  }).timeout(TIMEOUT);
...
describe('MarketSell', function () {
  it('Attempt to sell ETH at market price', function (done) {
    let quantity = 0.001;
    assert(
      typeof binance.spot.marketSell('ETHBTC', quantity) === 'undefined',
      WARN_SHOULD_BE_UNDEFINED
    );
    done();
  }).timeout(TIMEOUT);
...
describe('Buy order advanced', function () {
  it('Attempt to buy BNB specifying order type', function (done) {
    ...
    let price = 0.069;
    assert(
      typeof binance.spot.buy('BNBETH', quantity, price, { type: type }) ===
        'undefined',
      WARN_SHOULD_BE_UNDEFINED
    );
    done();
...
describe('Sell Stop loss', function () {
  it('Attempt to create a stop loss order', function (done) {
    ...
    let stopPrice = 0.068;
    assert(
      typeof binance.spot.sell('ETHBTC', quantity, price, {
        stopPrice: stopPrice,
        type: type,
      }) === 'undefined',
      WARN_SHOULD_BE_UNDEFINED
...
describe('Cancel order', function () {
  it('Attempt to cancel an order', function (done) {
    let orderid = '7610385';
    binance.spot.cancel('ETHBTC', orderid, (error, response) => {
      debug(error);
      debug(response);
      assert(typeof error === 'object', WARN_SHOULD_BE_OBJ);
...
describe('Cancel orders', function () {
  it('Attempt to cancel all orders given a symbol', function (done) {
    binance.spot.cancelOrders('XMRBTC', (error, response) => {
      debug(error);
      debug(response);
...
describe('Open Orders', function () {
  it('Attempt to show all orders to ETHBTC', function (done) {
    binance.spot.openOrders('ETHBTC', (error, openOrders) => {
      debug(error);
      debug(openOrders);
      assert(typeof error === 'object', WARN_SHOULD_BE_OBJ);
...
describe('Order status', function () {
  it('Attempt to get the order status for a given order id', function (done) {
    binance.spot.orderStatus('ETHBTC', '1234567890', (error, orderStatus) => {
      debug(error);
      debug(orderStatus);
      assert(typeof error === 'object', WARN_SHOULD_BE_OBJ);
...
describe('trades', function () {
  it('Attempt get all trade history for given symbol', function (done) {
    binance.spot.trades('SNMBTC', (error, trades) => {
      debug(error);
      debug(trades);
      assert(typeof error === 'object', WARN_SHOULD_BE_OBJ);
...
describe('Exchange Info', function () {
  ...
  beforeEach(function (done) {
    binance.spot.exchangeInfo(function (error, data) {
      async_error = error;
      async_data = data;
      done(error);
    });
...
describe('System status', function () {
  ...
  /*global beforeEach*/
  beforeEach(function (done) {
    binance.wapi.systemStatus(function (error, data) {
      async_error = error;
      async_data = data;
      done(error);
    });
...
describe('Withdraw history', function () {
  it('Attempt to get withdraw history for BTC', function (done) {
    binance.wapi.withdrawHistory((error, result) => {
      debug(error);
      debug(result);
      assert(typeof error === 'object', WARN_SHOULD_BE_OBJ);
      assert(typeof result === 'object', WARN_SHOULD_BE_OBJ);
...
describe('Deposit history', function () {
  it('Attempt to get deposit history for all assets', function (done) {
    binance.wapi.depositHistory((error, result) => {
      debug(error);
      debug(result);
      assert(typeof error === 'object', WARN_SHOULD_BE_OBJ);
      assert(typeof result === 'object', WARN_SHOULD_BE_OBJ);
...
describe('Deposit address', function () {
  it('Attempt to get deposit address for BTC', function (done) {
    binance.wapi.depositAddress('BTC', (error, result) => {
      debug(error);
      debug(result);
      assert(typeof error === 'object', WARN_SHOULD_BE_OBJ);
      assert(typeof result === 'object', WARN_SHOULD_BE_OBJ);
  ...
  it('Attempt to get deposit address for XYZ', function (done) {
    binance.wapi.depositAddress('XYZ', (error, result) => {
      debug(error);
      debug(result);
      assert(typeof error === 'object', WARN_SHOULD_BE_OBJ);
      assert(typeof result === 'object', WARN_SHOULD_BE_OBJ);
...
describe('Account status', function () {
  it('Attempt to get account status', function (done) {
    binance.wapi.accountStatus((error, data) => {
      debug(error);
      debug(data);
      assert(typeof error === 'object', WARN_SHOULD_BE_OBJ);
...
describe('Account', function () {
  it('Attempt to get account information', function (done) {
    binance.spot.account((error, data) => {
      debug(error);
      debug(data);
      assert(typeof error === 'object', WARN_SHOULD_BE_OBJ);
      assert(typeof data === 'object', WARN_SHOULD_BE_OBJ);
...
describe('Aggtrades', function () {
  it('Attempt to get aggTrades for given symbol', function (done) {
    binance.spot.aggTrades('BNBBTC', { limit: 500 }, (error, response) => {
      assert(typeof error === 'object', WARN_SHOULD_BE_OBJ);
      assert(typeof response === 'object', WARN_SHOULD_BE_OBJ);
      assert(error === null, WARN_SHOULD_BE_NULL);
      assert(response !== null, WARN_SHOULD_BE_NOT_NULL);
...
describe('Recent Trades', function () {
  it('Attempt get recent Trades for a given symbol', function (done) {
    binance.spot.recentTrades('BNBBTC', (error, data) => {
      debug(error);
      debug(data);
      assert(typeof error === 'object', WARN_SHOULD_BE_OBJ);
      assert(typeof data === 'object', WARN_SHOULD_BE_OBJ);
...
describe('Historical Trades', function () {
  it('Attempt get Historical Trades for a given symbol', function (done) {
    binance.spot.historicalTrades('BNBBTC', (error, data) => {
      debug(error);
      debug(data);
      assert(typeof error === 'object', WARN_SHOULD_BE_OBJ);
      assert(typeof data === 'object', WARN_SHOULD_BE_OBJ);
...
describe('Websocket candlesticks', function () {
  let candlesticks;
  let cnt = 0;
  /*global beforeEach*/
  beforeEach(function (done) {
    this.timeout(TIMEOUT);
    binance.webSocket.candlesticks(['BNBBTC'], '1m', (a_candlesticks) => {
      cnt++;
      if (cnt > 1) return;
...
describe('Websocket depth', function () {
  let depth;
  let cnt = 0;
  /*global beforeEach*/
  beforeEach(function (done) {
    this.timeout(TIMEOUT);
    binance.webSocket.depth(['BNBBTC'], (e_depth) => {
      cnt++;
      if (cnt > 1) return;
      depth = e_depth;
      stopSockets();
...
describe('Websocket aggregated trades', function () {
  let trades;
  let cnt = 0;
  /*global beforeEach*/
  beforeEach(function (done) {
    this.timeout(TIMEOUT);
    binance.webSocket.aggTrades(['BNBBTC', 'ETHBTC'], (e_trades) => {
      cnt++;
      if (cnt > 1) return;
      trades = e_trades;
      stopSockets();
...
describe('Websocket (raw) trades', function () {
  let trades;
  let cnt = 0;
  /*global beforeEach*/
  beforeEach(function (done) {
    this.timeout(TIMEOUT);
    binance.webSocket.trades(['BNBBTC', 'ETHBTC'], (e_trades) => {
      cnt++;
      if (cnt > 1) return;
      trades = e_trades;
      stopSockets();
...
describe('Websocket miniticker', function () {
  let markets;
  let cnt = 0;
  beforeEach(function (done) {
    this.timeout(TIMEOUT);
    binance.webSocket.miniTicker((tick) => {
      cnt++;
      if (cnt > 1) return;
      markets = tick;
      stopSockets();
...
describe('Websocket symbol depthcache', function () {
  let symbol;
  let bids;
  let asks;
  let cnt = 0;
  beforeEach(function (done) {
    this.timeout(TIMEOUT);
    binance.webSocket.depthCache('BNBBTC', (a_symbol, a_depth) => {
      cnt++;
      if (cnt > 1) return;
      stopSockets(true);
      symbol = a_symbol;
...
describe('Websocket array depthcache', function () {
  let symbol;
  let bids;
  let asks;
  let cnt = 0;
  beforeEach(function (done) {
    this.timeout(TIMEOUT);
    binance.webSocket.depthCache(['BNBBTC', 'TRXBTC'], (a_symbol, a_depth) => {
      cnt++;
      if (cnt > 1) return;
      stopSockets();
      symbol = a_symbol;
...
describe('Staggered websocket symbol depthcache', function () {
  let symbol;
  let bids;
  let asks;
  let cnt = 0;
  beforeEach(function (done) {
    this.timeout(TIMEOUT);
    binance.webSocket.depthCacheStaggered('BNBBTC', (a_symbol, a_depth) => {
      cnt++;
      if (cnt > 1) return;
      stopSockets(true);
      symbol = a_symbol;
...
describe('Staggered Websocket array depthcache', function () {
  let symbol;
  let bids;
  let asks;
  let cnt = 0;
  beforeEach(function (done) {
    this.timeout(TIMEOUT);
    binance.webSocket.depthCacheStaggered(
      ['BNBBTC', 'TRXBTC'],
      (a_symbol, a_depth) => {
        cnt++;
        if (cnt > 1) return;
...
describe('Websocket chart', function () {
  let chart;
  let interval;
  let symbol;
  let cnt = 0;
...
describe('Websocket chart array', function () {
  let chart;
  let interval;
  let symbol;
  let cnt = 0;
...
describe( 'Websockets userdata', function() {
  ...
  beforeEach(function (done) {
    this.timeout( TIMEOUT );
    binance.webSocket.userData( data => {
      userdata = data;
      stopSockets();
      done();
    });
